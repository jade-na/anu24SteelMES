...
class GreeterStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ReqRemoteCommand = channel.unary_unary(
                '/hello.Greeter/ReqRemoteCommand',
                request_serializer=hello__pb2.RcmdRequest.SerializeToString,
                response_deserializer=hello__pb2.RcmdReply.FromString,
                _registered_method=True)
...
def add_GreeterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ReqRemoteCommand': grpc.unary_unary_rpc_method_handler(
                    servicer.ReqRemoteCommand,
                    request_deserializer=hello__pb2.RcmdRequest.FromString,
                    response_serializer=hello__pb2.RcmdReply.SerializeToString,
            ),
    }
...
class Greeter(object):
    ...
    def ReqRemoteCommand(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/hello.Greeter/ReqRemoteCommand',
            hello__pb2.RcmdRequest.SerializeToString,
            hello__pb2.RcmdReply.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
